...
<body>
    ...
    <?php
		...
		?>
    <h1 class="text-white text-center">Cadastrar Carros</h1>
    <form method="POST" action="proc_cars_add.php">


        <label class="text-white">Marca: </label>
        <input class="textfield form-control" type="text" name="marca" placeholder="Marca"><br><br>

        <label class="text-white">Modelo: </label>
        <input class="textfield form-control" type="text" name="modelo" placeholder="Digite o Modelo"><br><br>
