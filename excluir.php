...
<body>
    ...
    <h1 class="text-white text-center">Excluir Carro</h1>
    <br>
    <h2 class="text-white text-center">Verifique as infomações do carro , caso queria excluir, click no botão EXCLUIR
    </h2>
    <?php
		...
		?>
    <br>
    <form method="POST" action="proc_cars_delete.php">
        <input type="hidden" name="id" value="<?php echo $row_carros['id']; ?>">
        <br>
        <label class="text-white">Marca: </label>
        <input class="textfield form-control" type="text" name="marca" placeholder="Marca" disabled
            value="<?php echo $row_carros['marca']; ?>"><br><br>

        <label class="text-white">Modelo: </label>
        <input class="textfield form-control" type="text" name="modelo" placeholder="Digite o Modelo" disabled
            value="<?php echo $row_carros['modelo']; ?>"><br><br>

        <label class="text-white">Cor: </label>
        <input class="textfield form-control" type="text" name="cor" placeholder="Digite a Cor" disabled
            value="<?php echo $row_carros['cor']; ?>"><br><br>

        <input class="btn-login" type="submit" value="Excluir">
